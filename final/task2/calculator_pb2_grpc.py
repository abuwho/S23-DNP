...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PrintResult = channel.unary_unary(
                '/calculator.Calculator/PrintResult',
                request_serializer=calculator__pb2.Result.SerializeToString,
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PrintResult': grpc.unary_unary_rpc_method_handler(
                    servicer.PrintResult,
                    request_deserializer=calculator__pb2.Result.FromString,
...
class Calculator(object):
    ...
    def PrintResult(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calculator.Calculator/PrintResult',
            calculator__pb2.Result.SerializeToString,
            calculator__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
