...
def add_DatabaseServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'schema.Database', rpc_method_handlers)
...
class Database(object):
    ...
    def PutUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/schema.Database/PutUser',
    ...
    def DeleteUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/schema.Database/DeleteUser',
            schema__pb2.User.SerializeToString,
            schema__pb2.status.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetUsers(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/schema.Database/GetUsers',
